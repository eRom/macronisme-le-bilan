# Couverture : ecologie-energie

Matrice construite le 2026-08-03 (audit D1 + D2). Domaine pilote « dense »
du format : 95 fiches, le plus gros corpus du dossier (84 A, 11 B, 0 C).

## Périmètre (condensé du jugement)

Le climat (budgets carbone, émissions, contentieux), le système énergétique
(nucléaire, renouvelables, prix), les pesticides et la biodiversité, l'eau,
la rénovation énergétique et les mobilités. Transverses jugés ailleurs : la
Convention citoyenne comme promesse démocratique (`institutions`), le
maintien de l'ordre de Sainte-Soline (`libertes-publiques`), les moyens de
lutte contre les feux (`securite-civile`), l'agrégat budgétaire
(`finances-publiques`), le sort industriel d'EDF (`industrie`), les textes
européens (`europe`).

Limites d'entrée du jugement : run non convergé (17 angles aboutis sur 35,
échec concentré sur les passes de vérification documentaire), deux rapports
de la Cour des comptes 2026 jamais résolus (plan vélo, police de l'eau,
fiches en B), votes de la France au Conseil de l'UE non documentés, décompte
146/149 de la Convention citoyenne non établi, loi d'urgence agricole non
promulguée au jour du verdict.

## Matrice sous-thèmes × période

| Sous-thème | 2017-22 | 2022-24 | 2024-26 | Statut | Notes |
|---|---|---|---|---|---|
| Climat : trajectoire, budgets carbone, émissions | OK | OK | OK | saturé | de la loi Énergie-Climat au ralentissement 2026 |
| Climat : contentieux (Affaire du Siècle, Grande-Synthe, air) | OK | OK | OK | saturé | cycle complet, de la carence fautive à la clôture 2025 |
...
| Europe climat vue de France (taxonomie, MACF, Green Deal) | OK | OK | partiel | partiel | votes de la France au Conseil non documentés (EE-09) |
...
| EE-07 | T1 | Biodiversité : création de l'OFB (2019), SNB 2030 (2023) | P2 | Sous-thème du périmètre sans aucune fiche propre | ouvert |
| EE-08 | T2 | Charbon : redémarrage de Saint-Avold 2022-2023 contre la promesse de fermeture 2022 | P2 | Angle échoué du run ; enrichir la fiche Cordemais ou fiche dédiée | ouvert |
| EE-09 | T2 | Votes nominatifs de la France au Conseil de l'UE (omnibus, CSDDD, ETS2) | P2 | Écarté n° 6 du jugement faute de documentation ; le documenter peut le requalifier | ouvert |
| EE-10 | T2 | EPR2 après l'annonce : programme, coûts, financement, Penly | P2 | Mentionné par trois fiches, jamais porté | ouvert |
| EE-11 | T2 | Chronologie ministérielle 2025-2026 : décrets de nomination post-octobre 2025 | P2 | Point ouvert de la chronologie ; attributions sur presse seule | ouvert |
| EE-12 | T5 | Versement nucléaire universel : article précis de la LF 2025 (fiche B) | P2 | Point ouvert non tranché | ouvert |
| EE-13 | T2 | Fiscalité carbone : rendement budgétaire du gel, affectation TICPE | P3 | Lacune de preuve du run ; ne déplace pas la charge, qui tient sans | ouvert |
| EE-14 | T2 | Décompte 146/149 de la Convention citoyenne vs contestation de l'Observatoire | P3 | Non établi sur source primaire ; le jugement s'en passe explicitement | ouvert |
| EE-15 | T2 | MaPrimeRénov' : création 2020 (bascule depuis le CITE) | P3 | Les fiches d'effet suffisent au jugement | ouvert |

Notes de clôture hors file :

- Loi d'accélération du nucléaire (22/06/2023) : pas un trou, elle est portée
  par la fiche [[2023-06-22-nucleaire-50-pourcent-abandonne]] dont elle est
  l'objet (suppression du plafond de 50 %). Son identifiant corrigé
  (JORFTEXT000047715784) est acté dans la chronologie du 29/07/2026.
- PPE 3 : lacune déclarée par le run mais déjà couverte en base
  ([[2026-02-12-planification-ecologique-par-decrets]]) — illustration de la
  règle « vérifier la base avant de traiter une lacune de run comme un trou ».
- Le creux 2017-2020 de l'histogramme (14 fiches sur 95) est expliqué pour
  l'essentiel par EE-01, EE-05, EE-07 et EE-15 : pas de ligne T3 séparée, les
  trous structurels le portent déjà.
- Transferts statistiques EnR post-2020 : allégation à ne jamais verser
  (aucune source primaire), déjà actée par la chronologie et l'écarté n° 5.

## Signaux en attente (T7, non triés)

Aucun (le signal ASTRID est trié, voir EE-01 et `signaux.md`).
